...
import org.teiid84.sql.impl.CrossQueryMetadata;
import org.teiid84.sql.impl.SyntaxFactory;
import org.teiid84.sql.impl.validator.WrappedQueryResolver;
import org.teiid84.sql.impl.validator.WrappedUpdateValidator;
import org.teiid84.sql.impl.validator.WrappedValidator;
import org.teiid84.sql.impl.visitor.CallbackSQLStringVisitor;
import org.teiid84.sql.impl.visitor.WrappedResolverVisitor;
import org.teiid84.sql.impl.xml.MappingDocumentFactory;
import org.teiid84.sql.proc.ProcedureService;
...
public class QueryService implements IQueryService {
    ...
    private final SystemFunctionManager systemFunctionManager = new SystemFunctionManager(QueryService.class.getClassLoader());
    ...
    public IFunctionLibrary createFunctionLibrary(List<FunctionMethodDescriptor> functionMethodDescriptors) {
        ...
        for (FunctionMethodDescriptor descriptor : functionMethodDescriptors) {
            ...
            if (tree == null) {
                tree = new FunctionTree(descriptor.getSchema(), new UDFSource(Collections.EMPTY_LIST, getClass().getClassLoader()), false);
